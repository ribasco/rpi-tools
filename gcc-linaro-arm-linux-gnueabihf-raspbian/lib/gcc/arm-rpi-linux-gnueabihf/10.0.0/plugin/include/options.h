...
enum opt_code
{
  ...
  OPT_Wstring_compare = 415,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 416, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 417,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 418,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 419,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 420,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 421,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 422,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 423,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 424,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 425,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 426,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 427,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 428,               /* -Wsuggest-override */
  OPT_Wsurprising = 429,                     /* -Wsurprising */
  OPT_Wswitch = 430,                         /* -Wswitch */
  OPT_Wswitch_bool = 431,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 432,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 433,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 434,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 435,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 436,                      /* -Wsync-nand */
  OPT_Wsynth = 437,                          /* -Wsynth */
  OPT_Wsystem_headers = 438,                 /* -Wsystem-headers */
  OPT_Wtabs = 439,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 440,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 441,           /* -Wtautological-compare */
  OPT_Wtemplates = 442,                      /* -Wtemplates */
  OPT_Wterminate = 443,                      /* -Wterminate */
  OPT_Wtraditional = 444,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 445,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 446,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 447,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 448,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 449,            /* -Wundeclared-selector */
  OPT_Wundef = 450,                          /* -Wundef */
  OPT_Wundefined_do_loop = 451,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 452,                      /* -Wunderflow */
  OPT_Wuninitialized = 453,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 454,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 455, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 456, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 457,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 458,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 459,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 460,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 461, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 462,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 463,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 464,                /* -Wunused-function */
  OPT_Wunused_label = 465,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 466,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 467,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 468,               /* -Wunused-parameter */
  OPT_Wunused_result = 469,                  /* -Wunused-result */
  OPT_Wunused_value = 470,                   /* -Wunused-value */
  OPT_Wunused_variable = 471,                /* -Wunused-variable */
  OPT_Wuse_without_only = 472,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 473,                   /* -Wuseless-cast */
  OPT_Wvarargs = 474,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 475,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 476,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 477,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 478,            /* -Wvirtual-move-assign */
  OPT_Wvla = 479,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 480,               /* -Wvla-larger-than= */
  OPT_Wvolatile = 481,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 482,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 483,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 484,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 485,                       /* -Wzerotrip */
  OPT_X = 486,                               /* -X */
  OPT_Xassembler = 487,                      /* -Xassembler */
  OPT_Xf = 488,                              /* -Xf */
  OPT_Xlinker = 489,                         /* -Xlinker */
  OPT_Xpreprocessor = 490,                   /* -Xpreprocessor */
  OPT_Z = 491,                               /* -Z */
  OPT_ansi = 492,                            /* -ansi */
  OPT_aux_info = 493,                        /* -aux-info */
  /* OPT_aux_info_ = 494, */                 /* -aux-info= */
  OPT_auxbase = 495,                         /* -auxbase */
  OPT_auxbase_strip = 496,                   /* -auxbase-strip */
  OPT_c = 497,                               /* -c */
  OPT_callgraph = 498,                       /* -callgraph */
  OPT_coverage = 499,                        /* -coverage */
  OPT_cpp = 500,                             /* -cpp */
  OPT_cpp_ = 501,                            /* -cpp= */
  OPT_d = 502,                               /* -d */
  OPT_debuglib_ = 503,                       /* -debuglib= */
  OPT_defaultlib_ = 504,                     /* -defaultlib= */
  OPT_defined_only = 505,                    /* -defined-only */
  OPT_demangle = 506,                        /* -demangle */
  OPT_dstartfiles = 507,                     /* -dstartfiles */
  OPT_dump_body_ = 508,                      /* -dump-body= */
  OPT_dump_level_ = 509,                     /* -dump-level= */
  OPT_dumpbase = 510,                        /* -dumpbase */
  OPT_dumpdir = 511,                         /* -dumpdir */
  OPT_dumpfullversion = 512,                 /* -dumpfullversion */
  OPT_dumpmachine = 513,                     /* -dumpmachine */
  OPT_dumpspecs = 514,                       /* -dumpspecs */
  OPT_dumpversion = 515,                     /* -dumpversion */
  OPT_e = 516,                               /* -e */
  OPT_export_dynamic = 517,                  /* -export-dynamic */
  OPT_fPIC = 518,                            /* -fPIC */
  OPT_fPIE = 519,                            /* -fPIE */
  OPT_fRTS_ = 520,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 521,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 522,                   /* -fabi-version= */
  OPT_faccess_control = 523,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 524,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 525,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 526,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 527,                  /* -falign-commons */
  OPT_falign_functions = 528,                /* -falign-functions */
  OPT_falign_functions_ = 529,               /* -falign-functions= */
  OPT_falign_jumps = 530,                    /* -falign-jumps */
  OPT_falign_jumps_ = 531,                   /* -falign-jumps= */
  OPT_falign_labels = 532,                   /* -falign-labels */
  OPT_falign_labels_ = 533,                  /* -falign-labels= */
  OPT_falign_loops = 534,                    /* -falign-loops */
  OPT_falign_loops_ = 535,                   /* -falign-loops= */
  /* OPT_faligned_new = 536, */              /* -faligned-new */
  OPT_faligned_new_ = 537,                   /* -faligned-new= */
  OPT_fall_instantiations = 538,             /* -fall-instantiations */
  OPT_fall_intrinsics = 539,                 /* -fall-intrinsics */
  OPT_fall_virtual = 540,                    /* -fall-virtual */
  OPT_fallocation_dce = 541,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 542,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 543,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 544,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 545,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 546,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 547,         /* -falt-external-templates */
  /* OPT_fargument_alias = 548, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 549, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 550, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 551, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 552,            /* -fasan-shadow-offset= */
  OPT_fasm = 553,                            /* -fasm */
  OPT_fassert = 554,                         /* -fassert */
  OPT_fassociative_math = 555,               /* -fassociative-math */
  OPT_fassume_phsa = 556,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 557,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 558,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 559,                   /* -fauto-profile */
  OPT_fauto_profile_ = 560,                  /* -fauto-profile= */
  OPT_fautomatic = 561,                      /* -fautomatic */
  OPT_fbackslash = 562,                      /* -fbackslash */
  OPT_fbacktrace = 563,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 564,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 565,                   /* -fbounds-check */
  OPT_fbounds_check_ = 566,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 567,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 568,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 569, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 570, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 571, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 572,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 573,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 574,                        /* -fbuiltin */
  OPT_fbuiltin_ = 575,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 576,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 577,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 578,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 579,                    /* -fcall-saved- */
  OPT_fcall_used_ = 580,                     /* -fcall-used- */
  OPT_fcaller_saves = 581,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 582,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 583, */            /* -fcf-protection */
  OPT_fcf_protection_ = 584,                 /* -fcf-protection= */
  OPT_fchar8_t = 585,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 586,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 587, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 588,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 589,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 590,                         /* -fcheck= */
  OPT_fchecking = 591,                       /* -fchecking */
  OPT_fchecking_ = 592,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 593,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 594,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 595,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 596,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 597,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 598,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 599,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 600,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 601, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 602,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 603,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 604,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 605, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 606,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 607,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 608,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 609,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 610,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 611, */                 /* -fcilkplus */
  OPT_fcoarray_ = 612,                       /* -fcoarray= */
  OPT_fcode_hoisting = 613,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 614,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 615,                         /* -fcommon */
  OPT_fcompare_debug = 616,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 617,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 618,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 619,                   /* -fcompare-elim */
  OPT_fconcepts = 620,                       /* -fconcepts */
  OPT_fconcepts_ts = 621,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 622,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 623, */           /* -fconserve-space */
  OPT_fconserve_stack = 624,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 625,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 626,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 627,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 628,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 629,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 630,                       /* -fconvert= */
  OPT_fcprop_registers = 631,                /* -fcprop-registers */
  OPT_fcray_pointer = 632,                   /* -fcray-pointer */
  OPT_fcrossjumping = 633,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 634,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 635, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 636,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 637,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 638,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 639,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 640,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 641,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 642,                       /* -fdbg-cnt= */
  OPT_fdce = 643,                            /* -fdce */
  OPT_fdebug = 644,                          /* -fdebug */
  OPT_fdebug_cpp = 645,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 646,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 647,            /* -fdebug-types-section */
  OPT_fdebug_ = 648,                         /* -fdebug= */
  OPT_fdec = 649,                            /* -fdec */
  OPT_fdec_blank_format_item = 650,          /* -fdec-blank-format-item */
  OPT_fdec_format_defaults = 651,            /* -fdec-format-defaults */
  OPT_fdec_include = 652,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 653,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 654,                       /* -fdec-math */
  OPT_fdec_static = 655,                     /* -fdec-static */
  OPT_fdec_structure = 656,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 657,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 658, */         /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 659,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 660, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 661,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 662,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 663,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 664,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 665,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 666,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 667,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 668,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 669,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 670,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 671,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 672, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 673,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 674,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 675,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 676,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 677,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 678,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_labels = 679,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 680,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 681,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 682,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 683, /* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 684,              /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 685,                /* -fdirectives-only */
  OPT_fdisable_ = 686,                       /* -fdisable- */
  OPT_fdoc = 687,                            /* -fdoc */
  OPT_fdoc_dir_ = 688,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 689,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 690,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 691,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 692,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 693,                       /* -fdruntime */
  OPT_fdse = 694,                            /* -fdse */
  OPT_fdump_ = 695,                          /* -fdump- */
  OPT_fdump_ada_spec = 696,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 697,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 698, */                /* -fdump-core */
  OPT_fdump_d_original = 699,                /* -fdump-d-original */
  OPT_fdump_final_insns = 700,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 701,              /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 702,            /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 703,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 704,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 705,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 706,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 707,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 708, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 709,                    /* -fdump-passes */
  OPT_fdump_scos = 710,                      /* -fdump-scos */
  OPT_fdump_unnumbered = 711,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 712,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 713,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 714,                 /* -fearly-inlining */
  OPT_felide_constructors = 715,             /* -felide-constructors */
  OPT_felide_type = 716,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 717, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 718, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 719,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 720,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 721,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 722,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 723,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 724,                        /* -fenable- */
  OPT_fenforce_eh_specs = 725,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 726,                 /* -fenum-int-equiv */
  OPT_fexceptions = 727,                     /* -fexceptions */
  OPT_fexcess_precision_ = 728,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 729,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 730,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 731,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 732,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 733,                /* -fextern-tls-init */
  OPT_fexternal_blas = 734,                  /* -fexternal-blas */
  OPT_fexternal_templates = 735,             /* -fexternal-templates */
  OPT_ff2c = 736,                            /* -ff2c */
  OPT_ffast_math = 737,                      /* -ffast-math */
  OPT_ffat_lto_objects = 738,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 739,               /* -ffile-prefix-map= */
  OPT_ffinite_loops = 740,                   /* -ffinite-loops */
  OPT_ffinite_math_only = 741,               /* -ffinite-math-only */
  OPT_ffixed_ = 742,                         /* -ffixed- */
  OPT_ffixed_form = 743,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 744,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 745,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 746,                    /* -ffloat-store */
  OPT_ffor_scope = 747,                      /* -ffor-scope */
  /* OPT_fforce_addr = 748, */               /* -fforce-addr */
  OPT_fforward_propagate = 749,              /* -fforward-propagate */
  OPT_ffp_contract_ = 750,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 751,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 752,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 753,                      /* -ffpe-trap= */
  OPT_ffree_form = 754,                      /* -ffree-form */
  OPT_ffree_line_length_ = 755,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 756,          /* -ffree-line-length-none */
  OPT_ffreestanding = 757,                   /* -ffreestanding */
  OPT_ffriend_injection = 758,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 759,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 760,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 761,                   /* -ffunction-cse */
  OPT_ffunction_sections = 762,              /* -ffunction-sections */
  OPT_fgcse = 763,                           /* -fgcse */
  OPT_fgcse_after_reload = 764,              /* -fgcse-after-reload */
  OPT_fgcse_las = 765,                       /* -fgcse-las */
  OPT_fgcse_lm = 766,                        /* -fgcse-lm */
  OPT_fgcse_sm = 767,                        /* -fgcse-sm */
  OPT_fgimple = 768,                         /* -fgimple */
  OPT_fgnat_encodings_ = 769,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 770,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 771,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 772,                         /* -fgnu-tm */
  OPT_fgnu_unique = 773,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 774,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 775,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 776,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 777,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 778,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 779,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 780,          /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 781,          /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 782,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 783,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 784,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 785,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 786,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 787,                       /* -fgraphite */
  OPT_fgraphite_identity = 788,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 789,       /* -fguess-branch-probability */
  OPT_fguiding_decls = 790,                  /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 791, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 792, */                     /* -fhelp */
  /* OPT_fhelp_ = 793, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 794,           /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 795,                      /* -fhonor-std */
  OPT_fhosted = 796,                         /* -fhosted */
  OPT_fhuge_objects = 797,                   /* -fhuge-objects */
  OPT_fident = 798,                          /* -fident */
  OPT_fif_conversion = 799,                  /* -fif-conversion */
  OPT_fif_conversion2 = 800,                 /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 801,         /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 802,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 803,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 804,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 805,             /* -fimplicit-templates */
  OPT_findirect_inlining = 806,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 807,         /* -finhibit-size-directive */
  OPT_finit_character_ = 808,                /* -finit-character= */
  OPT_finit_derived = 809,                   /* -finit-derived */
  OPT_finit_integer_ = 810,                  /* -finit-integer= */
  OPT_finit_local_zero = 811,                /* -finit-local-zero */
  OPT_finit_logical_ = 812,                  /* -finit-logical= */
  OPT_finit_real_ = 813,                     /* -finit-real= */
  OPT_finline = 814,                         /* -finline */
  OPT_finline_atomics = 815,                 /* -finline-atomics */
  OPT_finline_functions = 816,               /* -finline-functions */
  OPT_finline_functions_called_once = 817,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 818, */            /* -finline-limit- */
  OPT_finline_limit_ = 819,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 820,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 821,         /* -finline-small-functions */
  OPT_finput_charset_ = 822,                 /* -finput-charset= */
  OPT_finstrument_functions = 823,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 824,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 825,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 826,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 827,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 828,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 829,                     /* -finvariants */
  OPT_fipa_bit_cp = 830,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 831,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 832, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 833,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 834,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 835,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 836,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 837, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 838,                    /* -fipa-profile */
  OPT_fipa_pta = 839,                        /* -fipa-pta */
  OPT_fipa_pure_const = 840,                 /* -fipa-pure-const */
  OPT_fipa_ra = 841,                         /* -fipa-ra */
  OPT_fipa_reference = 842,                  /* -fipa-reference */
  OPT_fipa_reference_addressable = 843,      /* -fipa-reference-addressable */
  OPT_fipa_sra = 844,                        /* -fipa-sra */
  OPT_fipa_stack_alignment = 845,            /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 846, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 847,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 848,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 849,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 850,              /* -fira-loop-pressure */
  OPT_fira_region_ = 851,                    /* -fira-region= */
  OPT_fira_share_save_slots = 852,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 853,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 854,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 855,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 856,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 857,               /* -fivar-visibility= */
  OPT_fivopts = 858,                         /* -fivopts */
  OPT_fjump_tables = 859,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 860,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 861,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 862,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 863,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 864,          /* -fkeep-static-functions */
  OPT_flabels_ok = 865,                      /* -flabels-ok */
  OPT_flax_vector_conversions = 866,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 867,             /* -fleading-underscore */
  OPT_flifetime_dse = 868,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 869,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 870,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 871,                 /* -flinker-output= */
  /* OPT_flive_patching = 872, */            /* -flive-patching */
  OPT_flive_patching_ = 873,                 /* -flive-patching= */
  OPT_flive_range_shrinkage = 874,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 875,                    /* -flocal-ivars */
  /* OPT_floop_block = 876, */               /* -floop-block */
  /* OPT_floop_flatten = 877, */             /* -floop-flatten */
  OPT_floop_interchange = 878,               /* -floop-interchange */
  OPT_floop_nest_optimize = 879,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 880, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 881,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 882, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 883,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 884,                      /* -flra-remat */
  OPT_flto = 885,                            /* -flto */
  OPT_flto_compression_level_ = 886,         /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 887, */     /* -flto-odr-type-merging */
  OPT_flto_partition_ = 888,                 /* -flto-partition= */
  OPT_flto_report = 889,                     /* -flto-report */
  OPT_flto_report_wpa = 890,                 /* -flto-report-wpa */
  OPT_flto_ = 891,                           /* -flto= */
  OPT_fltrans = 892,                         /* -fltrans */
  OPT_fltrans_output_list_ = 893,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 894,              /* -fmacro-prefix-map= */
  OPT_fmain = 895,                           /* -fmain */
  OPT_fmath_errno = 896,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 897,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 898,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 899,         /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 900,             /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 901,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 902,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 903,                     /* -fmem-report */
  OPT_fmem_report_wpa = 904,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 905,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 906,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 907,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 908,                /* -fmessage-length= */
  OPT_fmodule_file_ = 909,                   /* -fmodule-file= */
  OPT_fmodule_private = 910,                 /* -fmodule-private */
  OPT_fmoduleinfo = 911,                     /* -fmoduleinfo */
  OPT_fmodulo_sched = 912,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 913,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 914,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 915,                  /* -fms-extensions */
  OPT_fmudflap = 916,                        /* -fmudflap */
  OPT_fmudflapir = 917,                      /* -fmudflapir */
  OPT_fmudflapth = 918,                      /* -fmudflapth */
  OPT_fname_mangling_version_ = 919,         /* -fname-mangling-version- */
  OPT_fnew_abi = 920,                        /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 921,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 922,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 923,                   /* -fnext-runtime */
  OPT_fnil_receivers = 924,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 925,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 926,               /* -fnonansi-builtins */
  OPT_fnonnull_objects = 927,                /* -fnonnull-objects */
  OPT_fnothrow_opt = 928,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 929,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 930,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 931,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 932,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 933,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 934,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 935,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 936,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 937,                   /* -foffload-abi= */
  OPT_foffload_ = 938,                       /* -foffload= */
  OPT_fomit_frame_pointer = 939,             /* -fomit-frame-pointer */
  OPT_fonly_ = 940,                          /* -fonly= */
  OPT_fopenacc = 941,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 942,                   /* -fopenacc-dim= */
  OPT_fopenmp = 943,                         /* -fopenmp */
  OPT_fopenmp_simd = 944,                    /* -fopenmp-simd */
  OPT_foperator_names = 945,                 /* -foperator-names */
  OPT_fopt_info = 946,                       /* -fopt-info */
  OPT_fopt_info_ = 947,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 948, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 949,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 950,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 951, */           /* -foptional-diags */
  OPT_fpack_derived = 952,                   /* -fpack-derived */
  OPT_fpack_struct = 953,                    /* -fpack-struct */
  OPT_fpack_struct_ = 954,                   /* -fpack-struct= */
  OPT_fpad_source = 955,                     /* -fpad-source */
  OPT_fpartial_inlining = 956,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 957,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 958,              /* -fpcc-struct-return */
  OPT_fpch_deps = 959,                       /* -fpch-deps */
  OPT_fpch_preprocess = 960,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 961,                     /* -fpeel-loops */
  OPT_fpeephole = 962,                       /* -fpeephole */
  OPT_fpeephole2 = 963,                      /* -fpeephole2 */
  OPT_fpermissive = 964,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 965,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 966,                            /* -fpic */
  OPT_fpie = 967,                            /* -fpie */
  OPT_fplan9_extensions = 968,               /* -fplan9-extensions */
  OPT_fplt = 969,                            /* -fplt */
  OPT_fplugin_arg_ = 970,                    /* -fplugin-arg- */
  OPT_fplugin_ = 971,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 972,            /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 973,                 /* -fpostconditions */
  OPT_fpre_include_ = 974,                   /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 975,             /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 976,                  /* -fpreconditions */
  OPT_fpredictive_commoning = 977,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 978,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 979,                   /* -fpreprocessed */
  OPT_fpretty_templates = 980,               /* -fpretty-templates */
  OPT_fprintf_return_value = 981,            /* -fprintf-return-value */
  OPT_fprofile = 982,                        /* -fprofile */
  OPT_fprofile_abs_path = 983,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 984,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 985,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 986,                   /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 987,         /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 988,          /* -fprofile-filter-files= */
  OPT_fprofile_generate = 989,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 990,              /* -fprofile-generate= */
  OPT_fprofile_note_ = 991,                  /* -fprofile-note= */
  OPT_fprofile_reorder_functions = 992,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 993,                 /* -fprofile-report */
  OPT_fprofile_update_ = 994,                /* -fprofile-update= */
  OPT_fprofile_use = 995,                    /* -fprofile-use */
  OPT_fprofile_use_ = 996,                   /* -fprofile-use= */
  OPT_fprofile_values = 997,                 /* -fprofile-values */
  OPT_fprotect_parens = 998,                 /* -fprotect-parens */
  OPT_frandom_seed = 999,                    /* -frandom-seed */
  OPT_frandom_seed_ = 1000,                  /* -frandom-seed= */
  OPT_frange_check = 1001,                   /* -frange-check */
  OPT_freal_4_real_10 = 1002,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1003,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1004,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1005,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1006,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1007,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1008,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1009,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1010,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1011,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1012,               /* -frecord-marker=8 */
  OPT_frecursive = 1013,                     /* -frecursive */
  OPT_free = 1014,                           /* -free */
  OPT_freg_struct_return = 1015,             /* -freg-struct-return */
  /* OPT_fregmove = 1016, */                 /* -fregmove */
  OPT_frelease = 1017,                       /* -frelease */
  OPT_frename_registers = 1018,              /* -frename-registers */
  OPT_freorder_blocks = 1019,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1020,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1021,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1022,             /* -freorder-functions */
  OPT_frepack_arrays = 1023,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1024,          /* -freplace-objc-classes */
  OPT_frepo = 1025,                          /* -frepo */
  OPT_freport_bug = 1026,                    /* -freport-bug */
  OPT_frequire_return_statement = 1027,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1028,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1029, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1030,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1031,                   /* -fresolution= */
  OPT_frounding_math = 1032,                 /* -frounding-math */
  OPT_frtti = 1033,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1034,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1035,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1036,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1037,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1038,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1039,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1040,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1041,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1042, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1043,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1044,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1045,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1046,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1047,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1048,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1049,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1050,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1051,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1052,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1053,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1054,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1055,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1056,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1057,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1058,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1059, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1060,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1061,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1062,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1063,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1064,               /* -fsection-anchors */
  /* OPT_fsee = 1065, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1066,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1067,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1068,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1069,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1070,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1071,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1072,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1073,                   /* -fshort-enums */
  OPT_fshort_wchar = 1074,                   /* -fshort-wchar */
  OPT_fshow_column = 1075,                   /* -fshow-column */
  OPT_fshrink_wrap = 1076,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1077,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1078,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1079,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1080,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1081,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1082,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1083,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1084,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1085,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1086,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1087,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1088,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1089,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1090,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1091,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1092,                      /* -fsquangle */
  OPT_fssa_backprop = 1093,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1094,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1095,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1096,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1097, */             /* -fstack-check */
  OPT_fstack_check_ = 1098,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1099,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1100,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1101,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1102,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1103,               /* -fstack-protector */
  OPT_fstack_protector_all = 1104,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1105,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1106,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1107,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1108,                   /* -fstack-usage */
  OPT_fstats = 1109,                         /* -fstats */
  OPT_fstdarg_opt = 1110,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1111,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1112, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1113,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1114,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1115,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1116,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1117,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1118, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1119,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1120,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1121,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1122,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1123,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1124, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1125,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1126, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1127,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1128, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1129,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1130,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1131,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1132,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1133,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1134,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1135,                   /* -ftime-report */
  OPT_ftime_report_details = 1136,           /* -ftime-report-details */
  OPT_ftls_model_ = 1137,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1138,              /* -ftoplevel-reorder */
  OPT_ftracer = 1139,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1140,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1141,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1142,                   /* -ftrampolines */
  OPT_ftransition_all = 1143,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1144,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1145,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1146,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1147,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1148,              /* -ftransition=field */
  OPT_ftransition_import = 1149,             /* -ftransition=import */
  OPT_ftransition_nogc = 1150,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1151,                /* -ftransition=tls */
  OPT_ftrapping_math = 1152,                 /* -ftrapping-math */
  OPT_ftrapv = 1153,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1154,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1155,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1156,                      /* -ftree-ccp */
  OPT_ftree_ch = 1157,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1158, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1159,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1160,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1161, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1162,                   /* -ftree-cselim */
  OPT_ftree_dce = 1163,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1164,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1165,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1166,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1167,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1168, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1169,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1170,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1171, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1172,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1173,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1174, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1175,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1176,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1177,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1178,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1179,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1180,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1181,                      /* -ftree-pre */
  OPT_ftree_pta = 1182,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1183,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1184, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1185,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1186,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1187,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1188,                     /* -ftree-slsr */
  OPT_ftree_sra = 1189,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1190, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1191, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1192,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1193,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1194,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1195, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1196,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1197, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1198,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1199,         /* -funconstrained-commons */
  OPT_funderscoring = 1200,                  /* -funderscoring */
  OPT_funit_at_a_time = 1201,                /* -funit-at-a-time */
  OPT_funittest = 1202,                      /* -funittest */
  OPT_funroll_all_loops = 1203,              /* -funroll-all-loops */
  OPT_funroll_loops = 1204,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1205, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1206,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1207,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1208,                 /* -funsigned-char */
  OPT_funswitch_loops = 1209,                /* -funswitch-loops */
  OPT_funwind_tables = 1210,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1211,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1212,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1213,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1214,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1215,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1216,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1217,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1218,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1219,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1220,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1221,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1222, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1223,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1224,                   /* -fverbose-asm */
  /* OPT_fversion = 1225, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1226,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1227,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1228,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1229,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1230,                   /* -fvisibility= */
  OPT_fvpt = 1231,                           /* -fvpt */
  OPT_fvtable_gc = 1232,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1233,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1234,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1235,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1236,                     /* -fvtv-debug */
  OPT_fweak = 1237,                          /* -fweak */
  OPT_fweb = 1238,                           /* -fweb */
  /* OPT_fwhole_file = 1239, */              /* -fwhole-file */
  OPT_fwhole_program = 1240,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1241,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1242,             /* -fworking-directory */
  OPT_fwpa = 1243,                           /* -fwpa */
  OPT_fwpa_ = 1244,                          /* -fwpa= */
  OPT_fwrapv = 1245,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1246,                 /* -fwrapv-pointer */
  OPT_fxref = 1247,                          /* -fxref */
  /* OPT_fzee = 1248, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1249,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1250,                     /* -fzero-link */
  OPT_g = 1251,                              /* -g */
  OPT_gant = 1252,                           /* -gant */
  OPT_gas_loc_support = 1253,                /* -gas-loc-support */
  OPT_gas_locview_support = 1254,            /* -gas-locview-support */
  OPT_gcoff = 1255,                          /* -gcoff */
  OPT_gcoff1 = 1256,                         /* -gcoff1 */
  OPT_gcoff2 = 1257,                         /* -gcoff2 */
  OPT_gcoff3 = 1258,                         /* -gcoff3 */
  OPT_gcolumn_info = 1259,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1260,                 /* -gdescribe-dies */
  OPT_gdwarf = 1261,                         /* -gdwarf */
  OPT_gdwarf_ = 1262,                        /* -gdwarf- */
  OPT_gen_decls = 1263,                      /* -gen-decls */
  OPT_ggdb = 1264,                           /* -ggdb */
  OPT_ggnu_pubnames = 1265,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1266,                   /* -gimple-stats */
  OPT_ginline_points = 1267,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1268, /* -ginternal-reset-location-views */
  OPT_gnat = 1269,                           /* -gnat */
  OPT_gnatO = 1270,                          /* -gnatO */
  OPT_gno_ = 1271,                           /* -gno- */
  OPT_gno_pubnames = 1272,                   /* -gno-pubnames */
  OPT_gpubnames = 1273,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1274,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1275,                   /* -gsplit-dwarf */
  OPT_gstabs = 1276,                         /* -gstabs */
  OPT_gstabs_ = 1277,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1278,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1279,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1280,                        /* -gtoggle */
  OPT_gvariable_location_views = 1281,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1282,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1283,                           /* -gvms */
  OPT_gxcoff = 1284,                         /* -gxcoff */
  OPT_gxcoff_ = 1285,                        /* -gxcoff+ */
  OPT_gz = 1286,                             /* -gz */
  OPT_gz_ = 1287,                            /* -gz= */
  OPT_h = 1288,                              /* -h */
  OPT_help = 1289,                           /* -help */
  OPT_idirafter = 1290,                      /* -idirafter */
  OPT_imacros = 1291,                        /* -imacros */
  OPT_imultiarch = 1292,                     /* -imultiarch */
  OPT_imultilib = 1293,                      /* -imultilib */
  OPT_include = 1294,                        /* -include */
  OPT_iplugindir_ = 1295,                    /* -iplugindir= */
  OPT_iprefix = 1296,                        /* -iprefix */
  OPT_iquote = 1297,                         /* -iquote */
  OPT_isysroot = 1298,                       /* -isysroot */
  OPT_isystem = 1299,                        /* -isystem */
  OPT_iwithprefix = 1300,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1301,              /* -iwithprefixbefore */
  OPT_k8 = 1302,                             /* -k8 */
  OPT_l = 1303,                              /* -l */
  OPT_lang_asm = 1304,                       /* -lang-asm */
  OPT_list = 1305,                           /* -list */
  OPT_mabi_ = 1306,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1307,             /* -mabort-on-noreturn */
  OPT_mandroid = 1308,                       /* -mandroid */
  OPT_mapcs = 1309,                          /* -mapcs */
  OPT_mapcs_frame = 1310,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1311,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1312,              /* -mapcs-stack-check */
  OPT_march_ = 1313,                         /* -march= */
  OPT_marm = 1314,                           /* -marm */
  OPT_masm_syntax_unified = 1315,            /* -masm-syntax-unified */
  OPT_mbe32 = 1316,                          /* -mbe32 */
  OPT_mbe8 = 1317,                           /* -mbe8 */
  OPT_mbig_endian = 1318,                    /* -mbig-endian */
  OPT_mbionic = 1319,                        /* -mbionic */
  OPT_mbranch_cost_ = 1320,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1321,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1322,     /* -mcaller-super-interworking */
  OPT_mcmse = 1323,                          /* -mcmse */
  OPT_mcpu_ = 1324,                          /* -mcpu= */
  OPT_mfdpic = 1325,                         /* -mfdpic */
  OPT_mfix_cortex_m3_ldrd = 1326,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1327,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1328,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1329,                  /* -mfp16-format= */
  OPT_mfpu_ = 1330,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1331,             /* -mgeneral-regs-only */
  OPT_mglibc = 1332,                         /* -mglibc */
  /* OPT_mhard_float = 1333, */              /* -mhard-float */
  OPT_mlittle_endian = 1334,                 /* -mlittle-endian */
  OPT_mlong_calls = 1335,                    /* -mlong-calls */
  OPT_mmusl = 1336,                          /* -mmusl */
  OPT_mneon_for_64bits = 1337,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1338,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1339,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1340,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1341,               /* -mprint-tune-info */
  OPT_mpure_code = 1342,                     /* -mpure-code */
  OPT_mrestrict_it = 1343,                   /* -mrestrict-it */
  OPT_msched_prolog = 1344,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1345,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1346,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1347, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1348,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1349,                         /* -mthumb */
  OPT_mthumb_interwork = 1350,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1351,                  /* -mtls-dialect= */
  OPT_mtp_ = 1352,                           /* -mtp= */
  OPT_mtpcs_frame = 1353,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1354,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1355,                         /* -mtune= */
  OPT_muclibc = 1356,                        /* -muclibc */
  OPT_munaligned_access = 1357,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1358,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1359,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1360,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1361,              /* -mword-relocations */
  OPT_n = 1362,                              /* -n */
  OPT_name_sort = 1363,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1364,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1365,              /* -no-integrated-cpp */
  OPT_no_pie = 1366,                         /* -no-pie */
  OPT_nocpp = 1367,                          /* -nocpp */
  OPT_nodefaultlibs = 1368,                  /* -nodefaultlibs */
  OPT_nolibc = 1369,                         /* -nolibc */
  OPT_nophoboslib = 1370,                    /* -nophoboslib */
  OPT_nostartfiles = 1371,                   /* -nostartfiles */
  OPT_nostdinc = 1372,                       /* -nostdinc */
  OPT_nostdinc__ = 1373,                     /* -nostdinc++ */
  OPT_nostdlib = 1374,                       /* -nostdlib */
  OPT_o = 1375,                              /* -o */
  OPT_objects = 1376,                        /* -objects */
  OPT_p = 1377,                              /* -p */
  OPT_pass_exit_codes = 1378,                /* -pass-exit-codes */
  /* OPT_pedantic = 1379, */                 /* -pedantic */
  OPT_pedantic_errors = 1380,                /* -pedantic-errors */
  OPT_pg = 1381,                             /* -pg */
  OPT_pie = 1382,                            /* -pie */
  OPT_pipe = 1383,                           /* -pipe */
  OPT_posix = 1384,                          /* -posix */
  OPT_print_file_name_ = 1385,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1386,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1387,          /* -print-multi-directory */
  OPT_print_multi_lib = 1388,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1389,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1390,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1391,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1392,               /* -print-prog-name= */
  OPT_print_search_dirs = 1393,              /* -print-search-dirs */
  OPT_print_sysroot = 1394,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1395,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1396,                    /* -print-value */
  OPT_profile = 1397,                        /* -profile */
  OPT_pthread = 1398,                        /* -pthread */
  OPT_quiet = 1399,                          /* -quiet */
  OPT_r = 1400,                              /* -r */
  OPT_rdynamic = 1401,                       /* -rdynamic */
  OPT_remap = 1402,                          /* -remap */
  OPT_reverse_sort = 1403,                   /* -reverse-sort */
  OPT_s = 1404,                              /* -s */
  OPT_save_temps = 1405,                     /* -save-temps */
  OPT_save_temps_ = 1406,                    /* -save-temps= */
  OPT_shared = 1407,                         /* -shared */
  OPT_shared_libgcc = 1408,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1409,               /* -shared-libphobos */
  OPT_size_sort = 1410,                      /* -size-sort */
  /* OPT_specs = 1411, */                    /* -specs */
  OPT_specs_ = 1412,                         /* -specs= */
  OPT_static = 1413,                         /* -static */
  OPT_static_libasan = 1414,                 /* -static-libasan */
  OPT_static_libgcc = 1415,                  /* -static-libgcc */
  OPT_static_libgfortran = 1416,             /* -static-libgfortran */
  OPT_static_libgo = 1417,                   /* -static-libgo */
  OPT_static_liblsan = 1418,                 /* -static-liblsan */
  OPT_static_libmpx = 1419,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1420,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1421,               /* -static-libphobos */
  OPT_static_libstdc__ = 1422,               /* -static-libstdc++ */
  OPT_static_libtsan = 1423,                 /* -static-libtsan */
  OPT_static_libubsan = 1424,                /* -static-libubsan */
  OPT_static_pie = 1425,                     /* -static-pie */
  /* OPT_std_c__03 = 1426, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1427, */                /* -std=c++0x */
  OPT_std_c__11 = 1428,                      /* -std=c++11 */
  OPT_std_c__14 = 1429,                      /* -std=c++14 */
  OPT_std_c__17 = 1430,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1431, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1432, */                /* -std=c++1z */
  OPT_std_c__2a = 1433,                      /* -std=c++2a */
  OPT_std_c__98 = 1434,                      /* -std=c++98 */
  OPT_std_c11 = 1435,                        /* -std=c11 */
  OPT_std_c17 = 1436,                        /* -std=c17 */
  /* OPT_std_c18 = 1437, */                  /* -std=c18 */
  /* OPT_std_c1x = 1438, */                  /* -std=c1x */
  OPT_std_c2x = 1439,                        /* -std=c2x */
  /* OPT_std_c89 = 1440, */                  /* -std=c89 */
  OPT_std_c90 = 1441,                        /* -std=c90 */
  OPT_std_c99 = 1442,                        /* -std=c99 */
  /* OPT_std_c9x = 1443, */                  /* -std=c9x */
  OPT_std_f2003 = 1444,                      /* -std=f2003 */
  OPT_std_f2008 = 1445,                      /* -std=f2008 */
  OPT_std_f2008ts = 1446,                    /* -std=f2008ts */
  OPT_std_f2018 = 1447,                      /* -std=f2018 */
  ...
  OPT_std_gnu__2a = 1457,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1458,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1459,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1460,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1461, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1462, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1463,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1464, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1465,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1466,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1467, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1468, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1469,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1470, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1471, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1472, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1473, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1474, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1475,                     /* -std=legacy */
  OPT_symbol_ = 1476,                        /* -symbol= */
  OPT_symbolic = 1477,                       /* -symbolic */
  OPT_t = 1478,                              /* -t */
  OPT_time = 1479,                           /* -time */
  OPT_time_ = 1480,                          /* -time= */
  OPT_tno_android_cc = 1481,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1482,                 /* -tno-android-ld */
  OPT_traditional = 1483,                    /* -traditional */
  OPT_traditional_cpp = 1484,                /* -traditional-cpp */
  OPT_tree_stats = 1485,                     /* -tree-stats */
  OPT_trigraphs = 1486,                      /* -trigraphs */
  OPT_type_stats = 1487,                     /* -type-stats */
  OPT_u = 1488,                              /* -u */
  OPT_undef = 1489,                          /* -undef */
  OPT_v = 1490,                              /* -v */
  OPT_version = 1491,                        /* -version */
  OPT_w = 1492,                              /* -w */
  OPT_wrapper = 1493,                        /* -wrapper */
  OPT_x = 1494,                              /* -x */
  OPT_z = 1495,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
