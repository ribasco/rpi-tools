...
#define HAVE_smullbvnx8hi (TARGET_SVE2)
#define HAVE_umullbvnx8hi (TARGET_SVE2)
#define HAVE_smulltvnx8hi (TARGET_SVE2)
#define HAVE_umulltvnx8hi (TARGET_SVE2)
#define HAVE_smullbvnx4si (TARGET_SVE2)
#define HAVE_umullbvnx4si (TARGET_SVE2)
#define HAVE_smulltvnx4si (TARGET_SVE2)
#define HAVE_umulltvnx4si (TARGET_SVE2)
#define HAVE_smullbvnx2di (TARGET_SVE2)
#define HAVE_umullbvnx2di (TARGET_SVE2)
#define HAVE_smulltvnx2di (TARGET_SVE2)
#define HAVE_umulltvnx2di (TARGET_SVE2)
#define HAVE_shrnbvnx16qi (TARGET_SVE2)
#define HAVE_rshrnbvnx16qi (TARGET_SVE2)
#define HAVE_shrnbvnx8hi (TARGET_SVE2)
#define HAVE_rshrnbvnx8hi (TARGET_SVE2)
#define HAVE_shrnbvnx4si (TARGET_SVE2)
#define HAVE_rshrnbvnx4si (TARGET_SVE2)
#define HAVE_shrntvnx16qi (TARGET_SVE2)
#define HAVE_rshrntvnx16qi (TARGET_SVE2)
#define HAVE_shrntvnx8hi (TARGET_SVE2)
#define HAVE_rshrntvnx8hi (TARGET_SVE2)
#define HAVE_shrntvnx4si (TARGET_SVE2)
#define HAVE_rshrntvnx4si (TARGET_SVE2)
...
extern rtx        gen_smullbvnx8hi                            (rtx, rtx, rtx);
extern rtx        gen_umullbvnx8hi                            (rtx, rtx, rtx);
extern rtx        gen_smulltvnx8hi                            (rtx, rtx, rtx);
extern rtx        gen_umulltvnx8hi                            (rtx, rtx, rtx);
extern rtx        gen_smullbvnx4si                            (rtx, rtx, rtx);
extern rtx        gen_umullbvnx4si                            (rtx, rtx, rtx);
extern rtx        gen_smulltvnx4si                            (rtx, rtx, rtx);
extern rtx        gen_umulltvnx4si                            (rtx, rtx, rtx);
extern rtx        gen_smullbvnx2di                            (rtx, rtx, rtx);
extern rtx        gen_umullbvnx2di                            (rtx, rtx, rtx);
extern rtx        gen_smulltvnx2di                            (rtx, rtx, rtx);
extern rtx        gen_umulltvnx2di                            (rtx, rtx, rtx);
extern rtx        gen_shrnbvnx16qi                            (rtx, rtx, rtx);
extern rtx        gen_rshrnbvnx16qi                           (rtx, rtx, rtx);
extern rtx        gen_shrnbvnx8hi                             (rtx, rtx, rtx);
extern rtx        gen_rshrnbvnx8hi                            (rtx, rtx, rtx);
extern rtx        gen_shrnbvnx4si                             (rtx, rtx, rtx);
extern rtx        gen_rshrnbvnx4si                            (rtx, rtx, rtx);
extern rtx        gen_shrntvnx16qi                            (rtx, rtx, rtx, rtx);
extern rtx        gen_rshrntvnx16qi                           (rtx, rtx, rtx, rtx);
extern rtx        gen_shrntvnx8hi                             (rtx, rtx, rtx, rtx);
extern rtx        gen_rshrntvnx8hi                            (rtx, rtx, rtx, rtx);
extern rtx        gen_shrntvnx4si                             (rtx, rtx, rtx, rtx);
extern rtx        gen_rshrntvnx4si                            (rtx, rtx, rtx, rtx);
