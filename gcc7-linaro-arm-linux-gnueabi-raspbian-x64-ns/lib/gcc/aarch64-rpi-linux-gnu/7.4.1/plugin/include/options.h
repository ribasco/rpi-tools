...
enum opt_code
{
  ...
  OPT_mabi_ = 1150,                          /* -mabi= */
  OPT_mandroid = 1151,                       /* -mandroid */
  OPT_march_ = 1152,                         /* -march= */
  OPT_mbig_endian = 1153,                    /* -mbig-endian */
  OPT_mbionic = 1154,                        /* -mbionic */
  OPT_mcmodel_ = 1155,                       /* -mcmodel= */
  OPT_mcpu_ = 1156,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1157,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1158,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1159,             /* -mgeneral-regs-only */
  OPT_mglibc = 1160,                         /* -mglibc */
  OPT_mlittle_endian = 1161,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1162,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1163,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1164,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1165,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1166,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1167,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1168,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1169,          /* -msign-return-address= */
  OPT_mstrict_align = 1170,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1171,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1172,                     /* -mtls-size= */
  OPT_mtune_ = 1173,                         /* -mtune= */
  OPT_muclibc = 1174,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1175,             /* -mverbose-cost-dump */
  OPT_n = 1176,                              /* -n */
  OPT_no_canonical_prefixes = 1177,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1178,              /* -no-integrated-cpp */
  OPT_no_pie = 1179,                         /* -no-pie */
  OPT_nocpp = 1180,                          /* -nocpp */
  OPT_nodefaultlibs = 1181,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1182,                   /* -nostartfiles */
  OPT_nostdinc = 1183,                       /* -nostdinc */
  OPT_nostdinc__ = 1184,                     /* -nostdinc++ */
  OPT_nostdlib = 1185,                       /* -nostdlib */
  OPT_o = 1186,                              /* -o */
  OPT_p = 1187,                              /* -p */
  OPT_pass_exit_codes = 1188,                /* -pass-exit-codes */
  /* OPT_pedantic = 1189, */                 /* -pedantic */
  OPT_pedantic_errors = 1190,                /* -pedantic-errors */
  OPT_pg = 1191,                             /* -pg */
  OPT_pie = 1192,                            /* -pie */
  OPT_pipe = 1193,                           /* -pipe */
  OPT_posix = 1194,                          /* -posix */
  ...
  OPT_profile = 1206,                        /* -profile */
  OPT_pthread = 1207,                        /* -pthread */
  OPT_quiet = 1208,                          /* -quiet */
  OPT_r = 1209,                              /* -r */
  OPT_rdynamic = 1210,                       /* -rdynamic */
  OPT_remap = 1211,                          /* -remap */
  OPT_s = 1212,                              /* -s */
  OPT_save_temps = 1213,                     /* -save-temps */
  OPT_save_temps_ = 1214,                    /* -save-temps= */
  OPT_shared = 1215,                         /* -shared */
  OPT_shared_libgcc = 1216,                  /* -shared-libgcc */
  /* OPT_specs = 1217, */                    /* -specs */
  OPT_specs_ = 1218,                         /* -specs= */
  OPT_static = 1219,                         /* -static */
  OPT_static_libasan = 1220,                 /* -static-libasan */
  OPT_static_libgcc = 1221,                  /* -static-libgcc */
  OPT_static_libgfortran = 1222,             /* -static-libgfortran */
  OPT_static_libgo = 1223,                   /* -static-libgo */
  OPT_static_liblsan = 1224,                 /* -static-liblsan */
  OPT_static_libmpx = 1225,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1226,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1227,               /* -static-libstdc++ */
  OPT_static_libtsan = 1228,                 /* -static-libtsan */
  OPT_static_libubsan = 1229,                /* -static-libubsan */
  /* OPT_std_c__03 = 1230, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1231, */                /* -std=c++0x */
  OPT_std_c__11 = 1232,                      /* -std=c++11 */
  OPT_std_c__14 = 1233,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1234, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1235, */                /* -std=c++1y */
  OPT_std_c__1z = 1236,                      /* -std=c++1z */
  OPT_std_c__98 = 1237,                      /* -std=c++98 */
  OPT_std_c11 = 1238,                        /* -std=c11 */
  /* OPT_std_c1x = 1239, */                  /* -std=c1x */
  /* OPT_std_c89 = 1240, */                  /* -std=c89 */
  OPT_std_c90 = 1241,                        /* -std=c90 */
  OPT_std_c99 = 1242,                        /* -std=c99 */
  /* OPT_std_c9x = 1243, */                  /* -std=c9x */
  OPT_std_f2003 = 1244,                      /* -std=f2003 */
  OPT_std_f2008 = 1245,                      /* -std=f2008 */
  OPT_std_f2008ts = 1246,                    /* -std=f2008ts */
  OPT_std_f95 = 1247,                        /* -std=f95 */
  OPT_std_gnu = 1248,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1249, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1250, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1251,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1252,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1253, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1254, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1255,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1256,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1257,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1258, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1259, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1260,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1261,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1262, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1263, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1264,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1265, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1266, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1267, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1268,                     /* -std=legacy */
  OPT_symbolic = 1269,                       /* -symbolic */
  OPT_t = 1270,                              /* -t */
  OPT_time = 1271,                           /* -time */
  OPT_time_ = 1272,                          /* -time= */
  OPT_tno_android_cc = 1273,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1274,                 /* -tno-android-ld */
  OPT_traditional = 1275,                    /* -traditional */
  OPT_traditional_cpp = 1276,                /* -traditional-cpp */
  OPT_trigraphs = 1277,                      /* -trigraphs */
  OPT_u = 1278,                              /* -u */
  OPT_undef = 1279,                          /* -undef */
  OPT_v = 1280,                              /* -v */
  OPT_version = 1281,                        /* -version */
  OPT_w = 1282,                              /* -w */
  OPT_wrapper = 1283,                        /* -wrapper */
  OPT_x = 1284,                              /* -x */
  OPT_z = 1285,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
