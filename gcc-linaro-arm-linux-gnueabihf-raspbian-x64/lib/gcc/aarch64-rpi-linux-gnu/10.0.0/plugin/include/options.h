...
#define MASK_OUTLINE_ATOMICS (1U << 2)
#define MASK_STRICT_ALIGN (1U << 3)
...
#define TARGET_OUTLINE_ATOMICS ((target_flags & MASK_OUTLINE_ATOMICS) != 0)
#define TARGET_OUTLINE_ATOMICS_P(target_flags) (((target_flags) & MASK_OUTLINE_ATOMICS) != 0)
...
enum opt_code
{
  ...
  OPT_list = 1305,                           /* -list */
  OPT_mabi_ = 1306,                          /* -mabi= */
  OPT_march_ = 1307,                         /* -march= */
  OPT_mbig_endian = 1308,                    /* -mbig-endian */
  OPT_mbionic = 1309,                        /* -mbionic */
  OPT_mbranch_protection_ = 1310,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1311,                       /* -mcmodel= */
  OPT_mcpu_ = 1312,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1313,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1314,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1315,             /* -mgeneral-regs-only */
  OPT_mglibc = 1316,                         /* -mglibc */
  OPT_mlittle_endian = 1317,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1318,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1319,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1320,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1321,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1322,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1323,               /* -moutline-atomics */
  OPT_moverride_ = 1324,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1325,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1326,          /* -msign-return-address= */
  ...
  OPT_mstack_protector_guard_ = 1329,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1330,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1331,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1332,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1333,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1334,             /* -mtrack-speculation */
  OPT_mtune_ = 1335,                         /* -mtune= */
  OPT_muclibc = 1336,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1337,             /* -mverbose-cost-dump */
  OPT_n = 1338,                              /* -n */
  OPT_name_sort = 1339,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1340,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1341,              /* -no-integrated-cpp */
  OPT_no_pie = 1342,                         /* -no-pie */
  OPT_nocpp = 1343,                          /* -nocpp */
  OPT_nodefaultlibs = 1344,                  /* -nodefaultlibs */
  OPT_nolibc = 1345,                         /* -nolibc */
  OPT_nophoboslib = 1346,                    /* -nophoboslib */
  OPT_nostartfiles = 1347,                   /* -nostartfiles */
  OPT_nostdinc = 1348,                       /* -nostdinc */
  OPT_nostdinc__ = 1349,                     /* -nostdinc++ */
  OPT_nostdlib = 1350,                       /* -nostdlib */
  OPT_o = 1351,                              /* -o */
  OPT_objects = 1352,                        /* -objects */
  OPT_p = 1353,                              /* -p */
  OPT_pass_exit_codes = 1354,                /* -pass-exit-codes */
  /* OPT_pedantic = 1355, */                 /* -pedantic */
  OPT_pedantic_errors = 1356,                /* -pedantic-errors */
  OPT_pg = 1357,                             /* -pg */
  OPT_pie = 1358,                            /* -pie */
  OPT_pipe = 1359,                           /* -pipe */
  OPT_posix = 1360,                          /* -posix */
  OPT_print_file_name_ = 1361,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1362,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1363,          /* -print-multi-directory */
  OPT_print_multi_lib = 1364,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1365,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1366,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1367,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1368,               /* -print-prog-name= */
  OPT_print_search_dirs = 1369,              /* -print-search-dirs */
  OPT_print_sysroot = 1370,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1371,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1372,                    /* -print-value */
  OPT_profile = 1373,                        /* -profile */
  OPT_pthread = 1374,                        /* -pthread */
  OPT_quiet = 1375,                          /* -quiet */
  OPT_r = 1376,                              /* -r */
  OPT_rdynamic = 1377,                       /* -rdynamic */
  OPT_remap = 1378,                          /* -remap */
  OPT_reverse_sort = 1379,                   /* -reverse-sort */
  OPT_s = 1380,                              /* -s */
  OPT_save_temps = 1381,                     /* -save-temps */
  OPT_save_temps_ = 1382,                    /* -save-temps= */
  OPT_shared = 1383,                         /* -shared */
  OPT_shared_libgcc = 1384,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1385,               /* -shared-libphobos */
  OPT_size_sort = 1386,                      /* -size-sort */
  /* OPT_specs = 1387, */                    /* -specs */
  OPT_specs_ = 1388,                         /* -specs= */
  OPT_static = 1389,                         /* -static */
  OPT_static_libasan = 1390,                 /* -static-libasan */
  OPT_static_libgcc = 1391,                  /* -static-libgcc */
  OPT_static_libgfortran = 1392,             /* -static-libgfortran */
  OPT_static_libgo = 1393,                   /* -static-libgo */
  OPT_static_liblsan = 1394,                 /* -static-liblsan */
  OPT_static_libmpx = 1395,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1396,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1397,               /* -static-libphobos */
  OPT_static_libstdc__ = 1398,               /* -static-libstdc++ */
  OPT_static_libtsan = 1399,                 /* -static-libtsan */
  OPT_static_libubsan = 1400,                /* -static-libubsan */
  OPT_static_pie = 1401,                     /* -static-pie */
  /* OPT_std_c__03 = 1402, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1403, */                /* -std=c++0x */
  OPT_std_c__11 = 1404,                      /* -std=c++11 */
  OPT_std_c__14 = 1405,                      /* -std=c++14 */
  OPT_std_c__17 = 1406,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1407, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1408, */                /* -std=c++1z */
  OPT_std_c__2a = 1409,                      /* -std=c++2a */
  OPT_std_c__98 = 1410,                      /* -std=c++98 */
  OPT_std_c11 = 1411,                        /* -std=c11 */
  OPT_std_c17 = 1412,                        /* -std=c17 */
  /* OPT_std_c18 = 1413, */                  /* -std=c18 */
  /* OPT_std_c1x = 1414, */                  /* -std=c1x */
  OPT_std_c2x = 1415,                        /* -std=c2x */
  /* OPT_std_c89 = 1416, */                  /* -std=c89 */
  OPT_std_c90 = 1417,                        /* -std=c90 */
  OPT_std_c99 = 1418,                        /* -std=c99 */
  /* OPT_std_c9x = 1419, */                  /* -std=c9x */
  OPT_std_f2003 = 1420,                      /* -std=f2003 */
  OPT_std_f2008 = 1421,                      /* -std=f2008 */
  OPT_std_f2008ts = 1422,                    /* -std=f2008ts */
  OPT_std_f2018 = 1423,                      /* -std=f2018 */
  OPT_std_f95 = 1424,                        /* -std=f95 */
  OPT_std_gnu = 1425,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1426, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1427, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1428,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1429,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1430,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1431, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1432, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1433,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1434,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1435,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1436,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1437, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1438, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1439,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1440, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1441,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1442,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1443, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1444, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1445,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1446, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1447, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1448, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1449, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1450, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1451,                     /* -std=legacy */
  OPT_symbol_ = 1452,                        /* -symbol= */
  OPT_symbolic = 1453,                       /* -symbolic */
  OPT_t = 1454,                              /* -t */
  OPT_time = 1455,                           /* -time */
  OPT_time_ = 1456,                          /* -time= */
  OPT_traditional = 1457,                    /* -traditional */
  OPT_traditional_cpp = 1458,                /* -traditional-cpp */
  OPT_tree_stats = 1459,                     /* -tree-stats */
  OPT_trigraphs = 1460,                      /* -trigraphs */
  OPT_type_stats = 1461,                     /* -type-stats */
  OPT_u = 1462,                              /* -u */
  OPT_undef = 1463,                          /* -undef */
  OPT_v = 1464,                              /* -v */
  OPT_version = 1465,                        /* -version */
  OPT_w = 1466,                              /* -w */
  OPT_wrapper = 1467,                        /* -wrapper */
  OPT_x = 1468,                              /* -x */
  OPT_z = 1469,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
